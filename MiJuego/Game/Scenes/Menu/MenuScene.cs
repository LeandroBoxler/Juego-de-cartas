...
public class MenuScene : IGameScene
{
    ...
    public void Update(GameTime gameTime)
    {
        if (_selectMenu.Update())
        {
            ...
            var battleService = ServiceContainer.GetBattleService();
            var botService = ServiceContainer.GetBotService();
            
            SceneManager.ChangeScene(new BattleScene(_gameState, battleService, botService));
        }
    }
